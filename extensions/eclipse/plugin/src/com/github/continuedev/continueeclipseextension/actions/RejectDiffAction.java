...
public final class RejectDiffAction extends AnAction {
   public void actionPerformed(@NotNull AnActionEvent e) {
      Intrinsics.checkNotNullParameter(e, "e");
      this.rejectHorizontalDiff(e);
      this.rejectVerticalDiff(e);
   }

   private final void rejectHorizontalDiff(AnActionEvent e) {
      ContinuePluginService var3 = ContinuePluginActionsKt.getPluginService(e.getProject());
      if (var3 != null) {
         DiffManager var4 = var3.getDiffManager();
         if (var4 != null) {
            var4.rejectDiff((String)null);
         }

      }
   }

   private final void rejectVerticalDiff(AnActionEvent e) {
