package com.github.continuedev.continueeclipseextension.views;
...
public class ContinueBrowser extends ViewPart implements ISelectionListener {

	/**
	 * The ID of the view as specified by the extension.
	 */
	public static final String ID = "com.github.continuedev.continueeclipseextension.views.ContinueBrowser";
	...
	public String getContent() {
		String js = null;
		try (InputStream inputStream = getClass().getResourceAsStream("ContinueBrowser.js")) {
